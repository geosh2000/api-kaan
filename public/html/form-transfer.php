...
<head>
    ...
    <title><?php echo ($lang === 'esp') ? 'Formulario de Transportación' : 'Transfer Form'; ?></title>
...
<div class="container">
    <div class="form-container">
        ...
        <form id="flight-form" action="http://localhost:8888/adhApi/index.php/public/addTransfer" method="post">
            <!-- Guest -->
